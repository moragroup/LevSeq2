...
class TestDeploy(TestClass):
    ...
    def test_variant_calling(self):
        ...
        # cl_args = {'skip_demultiplexing': False, 'skip_variantcalling': False, 'threshold': 0.5, 'oligopool': True}
        # cl_args["name"] = 'oligopool'
        # cl_args['path'] = '/mnt/storage01/home/amora/code/LevSeq2/fastq_pass/'
        # cl_args["summary"] = '/mnt/storage01/home/amora/code/LevSeq2/ref_oligo.csv' #'test_data/laragen_run/20241116-LevSeq-Review-Validation-levseq_ref.csv'
        # variant_df, ref_df = process_ref_csv(cl_args)
        # variant_df.to_csv('laragen_test_run_oligo.csv')


        cl_args = {'skip_demultiplexing': False, 'skip_variantcalling': False, 'threshold': 0.5, 'oligopool': True}
        cl_args["name"] = 'NBBBRB'
        cl_args['path'] = '/mnt/storage01/home/amora/code/LevSeq2/fastq_pass/'
        cl_args["summary"] = '/mnt/storage01/home/amora/code/LevSeq2/ref_new_barcodes.csv' #'test_data/laragen_run/20241116-LevSeq-Review-Validation-levseq_ref.csv'
        variant_df, ref_df = process_ref_csv(cl_args)
        variant_df.to_csv('laragen_test_run_barcodes.csv')
#  python levseq/cmd.py new_barcodes fastq_pass ref.csv --skip-demultiplexing
